...
//                }
    ...
    @IBAction func proofOfIncomeEyeTapped(_ sender: Any) {
        showWebView(with: .POIDetails, htmlString: "<div><div><table><tr><td colspan=\"2\"><b>Indicative List of Documents to Assess the “Profession and Source of Income/Fund” Self-employed/ Non-Salaried / Unemployed Persons</b></td><td colspan=\"2\"><b>Employed/ Salaried Persons</b></td></tr><tr><td><b>Proof of Business/ Work* (Any one of the following documents should suffice)</b></td><td><b>Source of Income/ Funds* (Any one of the following documents should suffice)</b></td><td><b>Proof of Profession* (Any one of the following documents should suffice)</b></td><td><b>Source of Income/ Funds* (Any one of the following documents should suffice)</b></td></tr><tr><td>Business/ Proprietor Letter Head; or any other Proof of Self Employment (e.g. Lawyer/ Doctor/ Consultant/ Freelancers/ Grocery Store/ Medical Store/ Labor Work etc.), OR</td><td>Receipt of Payment against the Work, OR</td><td>Valid Job/ Employee Card, OR</td><td>Latest Salary Slip, OR</td></tr><tr><td>Partnership/ Business Deed, OR</td><td>Partnership/ Business Deed, OR</td><td>Employer/ Job Certificate, OR </td><td>Salary Certificate, OR </td></tr><tr><td>Self-employed or unemployed women – Self-declaration, OR </td><td>Particulars of Income/ Funds Providers (e.g. Family Members/ Guardian/ Stipends/ Social Benefits etc.), OR</td><td>Employment Contract, OR</td><td>Payment Slips/ Record, OR</td></tr><tr><td>Valid Student ID Card/ Letter from Educational Institute, OR</td><td>Tax Statement/ Return/ Certificate, OR</td><td>Employer Letter, OR</td><td>Account Statement, OR</td></tr><tr><td>Valid Work Permit showing Business/ Nature of Work etc., OR</td><td>Self-declaration (In case of ADA, ADRA and Freelancer Digital Account), OR</td><td>Work Permit showing Profession/ Employment Details, OR</td><td>Tax Statement/ Return/ Certificate, OR</td></tr><tr><td>Self-declaration (In case of ADA, ADRA and Freelancer Digital Account), OR</td><td>Any other Document evidencing Source of Income</td><td>For Retired Persons, a copy of Retirement Letter/ Proof of Retirement, OR</td><td>For Retired Persons, an evidence of Terminal Benefits/ Pension Book etc., OR</td></tr><tr><td>Any other Document evidencing the Profession</td><td></td><td>Self-declaration (In case of ADA, ADRA and Freelancer Digital Acc</td><td>Self-declaration (In case of ADA, ADRA and Freelancer Digital Account), OR</td></tr><tr><td></td><td></td><td>Any other Document evidencing Source of Income</td><td>Any other Document evidencing Source of Income</td></tr></table></div></div>")
    }
