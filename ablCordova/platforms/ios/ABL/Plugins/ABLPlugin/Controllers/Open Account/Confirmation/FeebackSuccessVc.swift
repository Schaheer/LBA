//
//  FeebackSuccessVc.swift
//  ABL
//
//  Created by Robin Yaqoob on 02/01/2023.
//
...
@IBDesignable
class FeebackSuccessVc: UIViewController {
    ...
    @IBAction func submitFeedbackPressed(_ sender: Any) {
        self.view.window?.rootViewController?.dismiss(animated: true)
//        print(rating.rating)
//        let id = Int(getPrimaryUser().rdaCustomerProfileID ?? 0)
//        let feedback = Feedback(rating: Int(rating.rating), customerProfileId: id, questions: [])
//
//        APIManager.shared.saveFeedback(input: feedback) { [weak self] response in
...
//
//
//struct FeedbackModel: BaseInputModel {
//    let data: Feedback
//
...
//
//// MARK: - DataClass
//struct Feedback: BaseInputModel {
//    let rating: Int
//    let customerProfileId: Int
