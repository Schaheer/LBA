//
//  RegisterConsumerEmailResponseModel.swift
//  ABL
//
...
class RegisterConsumerEmailResponseModel: Mappable {
...
class RegisterConsumerEmailDataResponse: Mappable {

    var consumerList: [RegisterConsumerEmailConsumerList]?
...
class RegisterConsumerEmailConsumerList: Mappable {
