//
//  RegisterConsumerEmploymentDetailsResponseModel.swift
//  ABL
//
...
class RegisterConsumerEmploymentDetailsResponseModel: Mappable {

    var message: GenericMessageResponse?
    var data: RegisterConsumerEmploymentDetailsData?
...
class RegisterConsumerEmploymentDetailsData: Mappable {

    var consumerList: [RegisterConsumerEmploymentDetailsConsumerList]?
...
class RegisterConsumerEmploymentDetailsConsumerList: Mappable {
