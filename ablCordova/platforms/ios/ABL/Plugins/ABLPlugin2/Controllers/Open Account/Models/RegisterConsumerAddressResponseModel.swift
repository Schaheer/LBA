//
//  RegisterConsumerAddressResponseModel.swift
//  ABL
//
...
class RegisterConsumerAddressResponseModel: Mappable {
...
class RegisterConsumerAddressDataResponse: Mappable {

    var consumerList: [RegisterConsumerAddressConsumerList]?
...
class RegisterConsumerAddressConsumerList: Mappable {
...
class GenericMessageResponse: Mappable {
